...
<h1 style="width: 100%; background-color: #21395f; color: white; text-align: center; padding: 6px;">How to Open a New Account?</h1>
  <main class="container mx-auto mt-6">
   <div class="text-center mb-6">
    ...
    <p class="text-lg">
     Follow these steps to open a new account with us:
    </p><br><br><br>
   </div>
   <div style="margin-left: 20px; background-color: #4682b4; color: white; padding: 5px 10px; border: none; border-radius: 5px;">
    <ol class="list-decimal list-inside">
     <li>
      Click on user login buttonn.
     </li>
     <li>
      Find the new user sign up.
     </li>
     <li>
     Fill out the account opening form.
     </li>
     <li>
       Submit the required documents digitally along with the completed form.
     </li>
     <li>
     Our staff will verify your documents and process your application.
    </li> 
 </li>
      Once approved, you will receive your account details and welcome message.
     </li>
    </ol>
   </div>
  </main>
